...
- **[setup-project](./skills/setup-project/SKILL.md)** — Inspect a project, propose curated or researched lint rules plus its formatter, optional task runner, CI, hooks, and React application standards for approval, then install and verify the accepted setup.

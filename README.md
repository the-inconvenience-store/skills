...
- **[setup-project](./skills/setup-project/SKILL.md)** — Inspect a project, propose curated lint rules plus its format, CI, hooks, and optional React application standards for approval, then install and verify the accepted setup.

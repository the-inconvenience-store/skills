# Upstream audit — 2026-08-11

## Provenance

| Side | Revision | Source |
| --- | --- | --- |
| Upstream | `84fdeffd12f2ee307994d1eb6feb48173b6e0502` | https://github.com/mattpocock/skills.git |
| Local | `e998c244de22f5900e0ccf3742b8fd1e3d777adc` (dirty working tree) | `/Users/samstevens/skills-dev/skills` |
...
- **Consider adopting:** upstream adds `wait-what`; adds phase-boundary guidance to the `ask-matt` router; promotes `wizard` and `to-questionnaire`; and replaces `writing-great-skills` with the broader, model-invoked `writing-for-agents`. Twelve other promoted skills and two retained upstream drafts have smaller mapped changes that should be reviewed individually.
- **Preserve fork intent while porting:** the `ask-matt` and `setup-matt-pocock-skills` diffs include expected Inconvenient branding changes. The local setup skill also retains Beads support that is absent upstream, while local `writing-great-skills` remains user-invoked and narrower than upstream's replacement.
- **Resolve the upstream absence:** `in-progress/batch-grill-me` exists only in this fork. Treat it as a possible upstream deletion until deciding explicitly to retain or remove the draft.
- **Keep docs coupled to skill decisions:** upstream has new pages for `wizard`, `to-questionnaire`, and `wait-what`, and all 22 mapped pages differ. Port relevant docs with their skills while preserving the fork's renamed slugs.
- **No ignore-policy cleanup is needed:** all seven intentional upstream omissions matched, and no skill or docs ignore rule is stale. Ten mapped skills are unchanged.
...
| --- | --- | --- |
| `skills/productivity/wait-what` | `skills/wait-what` | 2 added upstream |

### Changed

| Upstream | Local | File delta |
| --- | --- | --- |
| `skills/engineering/ask-matt` | `skills/ask-inconvenient` | 1 added upstream, 2 modified |
| `skills/engineering/code-review` | `skills/code-review` | 1 modified |
| `skills/engineering/codebase-design` | `skills/codebase-design` | 1 modified |
| `skills/engineering/diagnosing-bugs` | `skills/diagnosing-bugs` | 2 modified |
| `skills/engineering/improve-codebase-architecture` | `skills/improve-codebase-architecture` | 1 modified |
| `skills/engineering/prototype` | `skills/prototype` | 2 modified |
| `skills/engineering/setup-matt-pocock-skills` | `skills/setup-inconvenient-skills` | 1 absent upstream, 6 modified |
...
| `skills/engineering/wizard` | `in-progress/wizard` | 3 modified |
...
| `skills/productivity/grilling` | `skills/grilling` | 2 modified |
| `skills/productivity/writing-for-agents` | `skills/writing-great-skills` | 1 absent upstream, 1 added upstream, 2 modified |

### Absent upstream

| Upstream | Local | File delta |
| --- | --- | --- |
| `—` | `in-progress/batch-grill-me` | 2 absent upstream |
...
| `skills/productivity/to-questionnaire` | `in-progress/to-questionnaire` |
...
| Upstream | Local | File delta |
| --- | --- | --- |
| `docs/engineering/wizard.md` | `docs/engineering/wizard.md` | 1 added upstream |
| `docs/productivity/to-questionnaire.md` | `docs/productivity/to-questionnaire.md` | 1 added upstream |
| `docs/productivity/wait-what.md` | `docs/productivity/wait-what.md` | 1 added upstream |
...
| `docs/productivity/writing-for-agents.md` | `docs/productivity/writing-great-skills.md` | 1 modified |
...
<details>
<summary><code>PHASE-BOUNDARIES.md</code> — added upstream</summary>
...
-These are canonical role names — the actual label strings used in the issue tracker may differ. The mapping should have been provided to you - run `/setup-inconvenient-skills` if not.
...
### `skills/engineering/wizard` → `in-progress/wizard`

Mapping note: Upstream promoted this skill while the fork still carries it as a draft.
...
~~~~diff
--- local/in-progress/wizard/SKILL.md
...
~~~~diff
--- local/in-progress/wizard/agents/openai.yaml
+++ upstream/skills/engineering/wizard/agents/openai.yaml
@@ -1,5 +1,3 @@
 interface:
   display_name: "Wizard"
...
~~~~diff
--- local/in-progress/wizard/template.sh
...
<details>
<summary><code>SKILL.md</code> — added upstream</summary>
...
<details>
<summary><code>agents/openai.yaml</code> — added upstream</summary>
...
### `skills/productivity/writing-for-agents` → `skills/writing-great-skills`

Mapping note: Upstream renamed and broadened writing-great-skills.

<details>
<summary><code>GLOSSARY.md</code> — absent upstream</summary>


~~~~diff
--- local/skills/writing-great-skills/GLOSSARY.md
+++ upstream/skills/productivity/writing-for-agents/GLOSSARY.md
@@ -1,201 +0,0 @@
...
<details>
<summary><code>SKILL-MECHANICS.md</code> — added upstream</summary>


~~~~diff
--- local/skills/writing-great-skills/SKILL-MECHANICS.md
...
~~~~diff
--- local/skills/writing-great-skills/SKILL.md
...
~~~~diff
--- local/skills/writing-great-skills/agents/openai.yaml
+++ upstream/skills/productivity/writing-for-agents/agents/openai.yaml
@@ -1,5 +1,3 @@
 interface:
...
~~~~diff
--- local/in-progress/batch-grill-me/SKILL.md
...
~~~~diff
--- local/in-progress/batch-grill-me/agents/openai.yaml
...
<details>
<summary><code>wizard.md</code> — added upstream</summary>
...
<details>
<summary><code>to-questionnaire.md</code> — added upstream</summary>
...
<details>
<summary><code>wait-what.md</code> — added upstream</summary>
...
### `docs/productivity/writing-for-agents.md` → `docs/productivity/writing-great-skills.md`
...
~~~~diff
--- local/docs/productivity/writing-great-skills.md
...
| Skill | `skills/engineering/wizard` | `in-progress/wizard` | Upstream promoted this skill while the fork still carries it as a draft |
| Skill | `skills/productivity/to-questionnaire` | `in-progress/to-questionnaire` | Upstream promoted this skill while the fork still carries it as a draft |
| Skill | `skills/productivity/writing-for-agents` | `skills/writing-great-skills` | Upstream renamed and broadened writing-great-skills |
...
| Docs | `docs/productivity/writing-for-agents.md` | `docs/productivity/writing-great-skills.md` | Upstream renamed and broadened writing-great-skills |
